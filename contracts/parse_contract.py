...
# ============================================================
# 集成方式（1号位）：
#   USE_MOCK = False → 引用 agents/pdf_parser.py 的真实实现（MinerU）
#   USE_MOCK = True  → 用下方 Mock 假数据
# 提示：MinerU 解析较慢（纯 CPU 可能数分钟），demo 时如未预热缓存，
#       可单独把这一个文件的 USE_MOCK 留 True，只演示 search→llm 真实链路。
# ============================================================
# 变更记录：
...
USE_MOCK = False   # demo 兜底 / MinerU 未装时改 True
