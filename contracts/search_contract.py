...
# ============================================================
# 集成方式（1号位）：
#   USE_MOCK = False → 引用 agents/search_agent.py 的真实实现
#   USE_MOCK = True  → 用下方 Mock 假数据（demo 兜底 / 离线开发）
# 切换只改这一行，app.py 与队友代码均无需改动。
# ============================================================
# 规则：
...
USE_MOCK = False   # demo 兜底：网络挂了 / 想离线开发时改 True

if not USE_MOCK:
    # 真实实现：2号位的 agents/search_agent.py
    from agents.search_agent import search_papers   # noqa: F401
